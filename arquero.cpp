...
Arquero::Arquero(string nombre,int ataque,int defensa,int vida,bool puedeAtacarVoladores,bool puedeVolar,int noFlechas):Guerrero(nombre,ataque,defensa,vida){
    //noFlechas=50;
    this->noFlechas = 50;
